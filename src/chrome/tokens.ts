...
html {
  --xiaohei-ink: #0A171B;
  --xiaohei-ink-soft: rgb(10 23 27 / 74%);
  ...
  --xiaohei-surface: rgb(10 27 34 / 94%);
  --xiaohei-surface-raised: rgb(16 38 46 / 97%);
  --xiaohei-surface-muted: rgb(7 23 29 / 74%);
  --xiaohei-sidebar-top: rgb(22 43 52 / 72%);
  --xiaohei-sidebar-middle: rgb(13 33 42 / 68%);
...
html[data-xiaohei-appearance='light'] {
  --xiaohei-ink: #17272B;
  --xiaohei-ink-soft: rgb(23 39 43 / 72%);
  --xiaohei-spirit: #2E747A;
  --xiaohei-spirit-strong: #285F65;
  --xiaohei-spirit-soft: rgb(46 116 122 / 11%);
  --xiaohei-spirit-faint: rgb(46 116 122 / 6%);
  --xiaohei-edge: rgb(40 101 106 / 23%);
  --xiaohei-edge-strong: rgb(40 101 106 / 42%);
  --xiaohei-surface: rgb(246 249 247 / 96%);
  --xiaohei-surface-raised: rgb(251 252 250 / 98%);
  --xiaohei-surface-muted: rgb(236 242 239 / 76%);
  --xiaohei-sidebar-top: rgb(244 246 242 / 68%);
  --xiaohei-sidebar-middle: rgb(235 241 237 / 62%);
