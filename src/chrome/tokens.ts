...
html {
  ...
  --xiaohei-workspace-folder-open: rgb(231 238 240 / 3%);
  --xiaohei-workspace-row-hover: rgb(231 238 240 / 4%);
  --xiaohei-workspace-row-active: rgb(231 238 240 / 12%);
  --xiaohei-workspace-row-active-hover: rgb(231 238 240 / 16%);
...
html[data-xiaohei-appearance='light'] {
  ...
  --xiaohei-workspace-folder-open: rgb(48 54 61 / 3%);
  --xiaohei-workspace-row-hover: rgb(48 54 61 / 5.5%);
  --xiaohei-workspace-row-active: rgb(48 54 61 / 10%);
  --xiaohei-workspace-row-active-hover: rgb(48 54 61 / 14%);
