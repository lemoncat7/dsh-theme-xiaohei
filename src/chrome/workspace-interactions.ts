...
#root [data-slot='sidebar'] [data-slot='sidebar.workspaces'] [role='treeitem'][aria-expanded]::after {
  ...
  border-radius: 11px;
  background:
    radial-gradient(circle at 16% 4px, rgb(198 255 244 / 94%) 0 1.2px, transparent 1.8px),
    radial-gradient(circle at 54% calc(100% - 3px), rgb(116 239 216 / 82%) 0 1px, transparent 1.7px),
    radial-gradient(circle at 88% 5px, rgb(155 255 235 / 72%) 0 0.9px, transparent 1.6px);
...
html[data-xiaohei-appearance='light'] #root [data-slot='sidebar'] [data-slot='sidebar.workspaces'] [role='treeitem'][aria-expanded]::after {
  background:
    radial-gradient(circle at 16% 4px, rgb(36 126 105 / 76%) 0 1.2px, transparent 1.8px),
    radial-gradient(circle at 54% calc(100% - 3px), rgb(49 147 124 / 64%) 0 1px, transparent 1.7px),
    radial-gradient(circle at 88% 5px, rgb(67 157 135 / 56%) 0 0.9px, transparent 1.6px);
}
