...
export const XIAOHEI_NIGHT_THEME = {
  ...
  colorScheme: 'dark',
  tokens: {
    '--dsw-alias-bg-base': 'rgb(8 16 20 / 78%)',
    '--dsw-alias-bg-layer-1': 'rgb(11 24 27 / 84%)',
    '--dsw-alias-bg-layer-2': 'rgb(15 32 34 / 89%)',
    '--dsw-alias-bg-layer-3': 'rgb(20 42 42 / 94%)',
    '--dsw-alias-bg-overlay': '#193333',
    '--dsw-alias-bg-module-platform': 'rgb(10 22 25 / 88%)',
    ...
    '--dsw-specific-sidebar-fill': 'rgb(7 17 20 / 88%)',
