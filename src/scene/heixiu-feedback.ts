...
html[data-xiaohei-state='thinking'] .xiaohei-scene__heixiu--composer .xiaohei-scene__heixiu-body {
  animation: xiaohei-heixiu-feedback-send 620ms cubic-bezier(0.22, 0.72, 0.24, 1) both;
}

html[data-xiaohei-state='complete'] .xiaohei-scene__heixiu--mascot .xiaohei-scene__heixiu-body,
html[data-xiaohei-state='complete'] .xiaohei-scene__heixiu--composer .xiaohei-scene__heixiu-body,
...
html[data-xiaohei-state='thinking'] .xiaohei-scene__heixiu--composer .xiaohei-scene__heixiu-open,
...
html[data-xiaohei-state='thinking'] .xiaohei-scene__heixiu--composer .xiaohei-scene__heixiu-blink,
...
@keyframes xiaohei-heixiu-feedback-send {
  0%, 100% { transform: translate3d(0, 0, 0); opacity: 1; }
  34% { transform: translate3d(0, -0.28rem, 0); opacity: 1; }
  68% { transform: translate3d(0, 0.08rem, 0); opacity: 0.94; }
}
