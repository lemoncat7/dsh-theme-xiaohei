...
- 左侧栏使用贯穿全高的水墨森林剪影和半透明宣纸材质重新组织品牌区、主操作、工作区与底部工具，并以潦草竖写的生图“罗小黑”签名占据纵向留白，不新增无功能入口。
- 工作区、工具区、会话输入区与浮层使用统一的“小黑框架”：放大的生图墨纸铭牌配合不同分区挂饰——猫尾灵珠、空间裂环、蓝嘴黑猫牌；工作区右侧额外内收，收起后所有工具回到同一条 35px 视觉轴。
