...
- 左侧栏使用分层半透明材质重新组织品牌区、主操作、工作区与底部工具，并在空白背景中加入独立的手写“小黑”墨迹签名，不新增无功能入口。
- 工作区、工具区、会话输入区与浮层使用统一的“小黑框架”：外框、内框、手写题签、猫爪墨印各自独立；工作区右侧额外内收，收起后所有工具回到同一条 35px 视觉轴。
...
- `data-xiaohei-frame-ornament="spirit-knot"`：兼容既有扩展的猫爪墨印入口；墨印嵌在框角，悬停时提供轻微转动反馈。
