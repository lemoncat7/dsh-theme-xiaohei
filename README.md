...
`Xiaohei Night` 是一个基于 DeepSeek Harness 官方主题注册接口开发的非官方粉丝主题插件。主题使用完整生成插画建立连续水墨灵域，并以炭黑、宣纸灰和青绿色妖灵力统一 DSH 的工作界面。
...
- 环境使用独立妖灵浮光，小黑脚下的椭圆灵力漩涡以外环和反向内环持续流动，动画仅改变 `transform` 与 `opacity`。
