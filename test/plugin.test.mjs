...
test('Sylva avatar is injected as one renderer-sharing optimized Hi3D model', () => {
  ...
  assert.match(modeled, /xiaohei-rig-head/)
  assert.match(modeled, /xiaoheiAvatarPoseMotion/)
  assert.match(modeled, /xiaohei-spirit-transit-ring-v1/)
  assert.match(modeled, /spirit-transit/)
  ...
  assert.match(modeled, /xiaohei-avatar-survey-wire-v1/)
